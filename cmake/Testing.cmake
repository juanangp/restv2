if(NOT DEFINED TEST OR NOT TEST)
  set(TEST OFF)
  message(
    STATUS "Testing disabled (Disabled by default, enabled via -DTEST=ON flag)")
endif()
if(TEST)
  message(
    STATUS "Testing enabled (Disabled by default, enabled via -DTEST=ON flag)")
  enable_testing()
...
macro(ADD_LIBRARY_TEST)
  if(TEST)
    ...
    target_link_libraries(
      ${TESTING_EXECUTABLE} PUBLIC ${LIBRARY_NAME} gtest_main RestFramework
                                   stdc++fs # <filesystem>
    )
