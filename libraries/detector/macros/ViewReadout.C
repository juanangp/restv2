...
void ViewReadout(const std::string& instanceName = "IAXO_D1_Readout",
                 const std::string& decodingName = "iaxo_d0_nominal.dec",
                 const std::string inputFile = "iaxo_readout_output.root") {
    ...
    std::cout << "Hit at (" << testX << ", " << testY << ", " << testZ
